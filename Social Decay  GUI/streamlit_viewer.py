...
# Paths & constants
# ══════════════════════════════════════════════════════════════════════════════
# Resolution order: NEURAL_DATA_DIR env var -> ../Data relative to this script
# (repo layout: <root>/Social Decay GUI/script.py -> <root>/Data) -> ./Data next to script.
_env = os.environ.get("NEURAL_DATA_DIR")
if _env and os.path.isdir(_env):
    DATA_DIR = os.path.normpath(_env)
else:
    _rel = os.path.normpath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "Data"))
    _flat = os.path.join(os.path.dirname(os.path.abspath(__file__)), "Data")
    DATA_DIR = _rel if os.path.isdir(_rel) else _flat
